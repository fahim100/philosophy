                    ...
                    <article class="col-block popular__post">
                        ...
                        <section class="popular__meta">
                            <span class="popular__author">
                                <span><?php echo __( "By", "philosiphy" ); ?></span>
                                <a href="<?php echo esc_url( get_the_author_posts_link( get_the_author_meta( "ID" ) ) ); ?>"><?php the_author(); ?></a>
                            </span>
                            <span class="popular__date">
                                <span><?php echo __( "on", "philosiphy" ); ?></span>
